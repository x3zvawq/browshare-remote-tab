...
Follow the [source setup guide](../../docs/getting-started.md#build-from-source) and
[Extension signing steps](../../docs/getting-started.md#build-and-sign-the-extension).

The TypeScript package exports managed-runtime parsing, Extension identity and tab-binding types, and the
...
The coordinated Extension accepts bounded `media.configure_quality` commands. It applies
...
[adaptation policy](../../docs/design/05-extension-and-core.md#automatic-encoder-quality) and
[testing and compatibility](../../docs/design/08-testing.md) for the supported runtime set.
